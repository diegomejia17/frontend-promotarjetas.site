      ...
      <div className="flex flex-col gap-6">
        ...
        >
          ...
          <input
            ...
            className="w-full bg-[#efe7dd] rounded-xl shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] pl-14 pr-12 py-[18px] text-[16px] text-[#42474b] placeholder:text-[rgba(115,120,123,0.7)] outline-none [&::-webkit-search-cancel-button]:hidden"
          />
          {searchQuery && (
            <button
              type="button"
              onClick={() => setSearchQuery('')}
              className="absolute right-[16px] top-1/2 -translate-y-1/2 w-[24px] h-[24px] flex items-center justify-center rounded-full bg-[rgba(115,120,123,0.15)] hover:bg-[rgba(115,120,123,0.25)] transition-colors text-[#42474b]"
            >
